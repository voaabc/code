window.onload = function () {
    ...
    createEarthBack('./images/earth-bg.png').then(function (image) {
        let m = image.height,
            n = image.width,
    ...
    function initEarth(opts) {
        ...
        const option = {
            ...
            globe: {
                ...
                environment: 'none',   //背景
                heightTexture: './images/earth-ba.jpg',
                baseTexture: './images/earth-bg.png',
                shading: 'lambert',
            ...
            series: [{
                ...
                data: [
                    ...
                    {
                        name: '广州', value: [113.16, 23.06]
                    },
                    {
                        name: '北京', value: [116.3, 39.9]
                    },
                    {
                        name: '东京', value: [139.660177, 35.860783]
                    },
                    {
                        name: '台北', value: [121.50, 25.05]
                    },
                    {
